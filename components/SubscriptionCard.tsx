...
const SubscriptionCard = ({ name, price, currency, icon, billing, color, category, renewalDate, plan, onPress, expanded, paymentMethod, startDate, status }: SubscriptionCardProps) => {
          ...
          <View className='sub-details'>
            ...
            <View className='sub-row'>
              <View className='sub-row-copy'>
                ...
                <Text className='sub-value' numberOfLines={1} ellipsizeMode='tail'>{formatSubscriptionDateTime(startDate ? startDate : '')}</Text>
              </View>
            </View> 
